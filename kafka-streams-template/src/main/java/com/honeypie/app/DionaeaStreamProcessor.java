...
public class DionaeaStreamProcessor {
    static String INPUT_TOPIC = "input.honeypot.dionaea";
    static String OUTPUT_TOPIC = "output.honeypot.dionaea";
    ...
    public static void main(String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "dionaea-app");
        ...
        stream.mapValues(raw -> {
            ...
            try {
                ...
                // Extract fields
                String protocol = root.get("connection").get("protocol").asText();
