...
public class CowrieStreamProcessor {
    static String INPUT_TOPIC = "input.honeypot.cowrie";
    static String OUTPUT_TOPIC = "output.honeypot.cowrie";
    ...
    public static void main(String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "cowrie-app");
