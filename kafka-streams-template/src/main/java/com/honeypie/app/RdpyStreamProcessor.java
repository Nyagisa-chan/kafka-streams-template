...
public class RdpyStreamProcessor {
    static String INPUT_TOPIC = "input.honeypot.rdpy";
    static String OUTPUT_TOPIC = "output.honeypot.rdpy";
    ...
    public static void main(String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "rdpy-app");
